...
/**
 * Check if mock data should be used (when Jamendo API is unavailable)
 */
export const shouldUseMockData = (): boolean => {
  // Use real Jamendo data if client ID is configured
  const hasJamendoClientId = !!(import.meta.env.VITE_JAMENDO_CLIENT_ID || '').trim();
  return !hasJamendoClientId;
};
